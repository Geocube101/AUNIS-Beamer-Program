...
disp.setForegrounds(0x332480)
disp.fill(80, 30, 50, 1, '▀')
disp.fill(80, 45, 50, 1, '▄')
disp.fill(80, 30, 1, 16, '█')
disp.fill(129, 30, 1, 16, '█')

disp.fill(82, 31, 45, 1, '─')
disp.fill(82, 44, 45, 1, '─')
disp.fill(82, 31, 1, 13, '│')
disp.fill(127, 31, 1, 13, '│')
...
disp.set(90, 33, '--[=[ Beamer Statistics ]=]--')
